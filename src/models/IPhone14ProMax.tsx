...
function IPhone14ProMax(props: JSX.IntrinsicElements['group']) {

  const { nodes, materials } = useGLTF(
      '/iPhone14ProMax/scene.gltf'
  ) as unknown as GLTFResult;

  return (
    <group {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]} position={[0, -1.7, 0]}>
        <group
...
useGLTF.preload('/iPhone14ProMax/scene.gltf');
